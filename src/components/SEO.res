...
let defaultTitle = "Sreyas Sabbani"
let defaultDescription = "I'm a math, physics, and CS enthusiast sharing insights about science, tech, and art. Explore my blog posts, projects, and some other fun thoughts."
let defaultKeywords = [
  "sreyas sabbani",
  "math",
  "physics",
